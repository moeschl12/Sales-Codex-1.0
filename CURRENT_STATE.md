...
**Stand: 2026-07-13 — V1.1 RELEASED — SCOPE-LIMITED**

Sales Codex Version 1.1 wurde durch Herausgeberentscheidung als autonomes Makroprojekt-Programm eröffnet und am 2026-07-13 durch Editor Release Decision (Felix) als **RELEASED — SCOPE-LIMITED** freigegeben (`00_project/projects/V11-08_final_audit_release/EDITOR_RELEASE_DECISION.md`). Freigegeben ist der evidenz-, governance- und auditkonsolidierte Repository-Stand von V11-01 bis V11-08 — **nicht** breite Delivery-Skalierung (weiterhin „begrenzt", V11-04-Befund unverändert in Kraft). Strategische Source of Truth ist `00_project/ROADMAP_V1_1.md`; operativer Launcher ist `00_project/NEXT_ACTION.md`. Version-1.0-Inhalte bleiben unverändert/frozen.

**Alle acht Makroprojekte abgeschlossen und unabhängig auditiert (COMPLETED — AUDITED):** `V11-01` — Baseline & Control Plane Consolidation (**PASS WITH CONDITIONS**, Bedingung erfüllt; eigenständiger Audit-Verfügbarkeitsvermerk persistiert 2026-07-13: `00_project/projects/V11-01_baseline_control_plane/AUDIT_REPORT.md`). `V11-02` — Evidence Architecture Resolution (**PASS**). `V11-03` — Governance + Repository Integrity + Atlas Operationalization (**PASS WITH CONDITIONS**, Bedingung geschlossen; Cross-Project Consistency V11-02/V11-03: CONSISTENT WITH MINOR DRIFT). `V11-04` — Early Delivery Vertical Slice (**PASS WITH CONDITIONS**, 0/0/4 Minor, alle geschlossen; Delivery-Scaling-Empfehlung **begrenzt, keine breite Skalierung** — vier Blocker seither unverändert offen: T12, Technik-Kandidaten, Zielgruppen-Tagging, MEC-0002/P-0002-Evidenzlevel). `V11-05` — Knowledge Consolidation & Integrated Synthesis (ursprünglich REWORK REQUIRED 0/1/3 → Rework → Re-Audit **PASS WITH CONDITIONS** 0/0/1, Condition C-01 geschlossen; W-001 korrekt als abgeschlossenes Forschungsprojekt eingeordnet, kanonische OQ-2-Identität — Omission-Kipppunkt im Buying Center — präzisiert). `V11-06` — Research Portfolio Wave 2 (**PASS WITH CONDITIONS**, 0/0/3 Minor, geschlossen 2026-07-12; Wave-Scope exakt ein Projekt, Editor-autorisiert 2026-07-07: **W-008**, OQ-2 aus W-001, Editor Decision „Teilweise annehmen", 4 Objekte erweitert — MEC-0016, MEC-0014, A-0031 —, kein neues Objekt; OQ-2 bleibt empirisch unbeantwortet, nur Primärexperiment kann klären). `V11-07` — Cross-System Review & Delivery Scaling Decision (**PASS WITH CONDITIONS**, 0/0/3 Minor, Audit durch Codex, geschlossen 2026-07-13; acht Risiken gerankt R-1–R-8, höchste Priorität: additives Synthesemuster im Research Program als **4. bestätigtes Vorkommen** W-002/W-003/W-004/W-008, sowie vier unadressierte V11-04-Delivery-Blocker). `V11-08` — Final Program Audit & Version 1.1 Release Decision (**PASS**, Final Audit + Re-Check durch Codex, 2026-07-13, 1 Major/2 Minor über beide Runden, alle geschlossen; Release-Kriterien-Verifikation aller sieben `V1_1_RELEASE_CRITERIA.md`-Abschnitte; **Editor Release Decision: V1.1 RELEASED — SCOPE-LIMITED**).

Details je Projekt: `00_project/ROADMAP_V1_1.md` (Program Board); Completion-/Audit-/Closure-Reports in den jeweiligen `00_project/projects/V11-XX_*/`-Ordnern. Nicht-blockierende, programmweit weitergeführte Punkte (Stand nach Governance-Integration-Block, 2026-07-13 — Details Abschnitt „Update" unten): T12/Status-„Validiert" (deferred seit V11-04); MEC-0002/P-0002-Evidenzlevel-Harmonisierung (registriert in `SCIENTIFIC_DEBT.md`); additives Synthesemuster (Methoden-Review-Kandidat, Editor-Autorisierung ausstehend); RP-005/RP-006 (unverändert blockiert); Delivery-/Research-Scaling (weiterhin nicht freigegeben); mögliche zukünftige Makroprojekte V11-09 ff. (kein Brief, keine Roadmap-Eintragung). Die vormals hier gelisteten vier Reserved Decisions OD-009 bis OD-012 sind entschieden — nicht mehr Teil dieser Liste. Vollständige Übersicht: `00_project/DECISION_STACK_2026-07-13.md`.

**Nächster Schritt:** Kein regulärer Makroprojekt-Launcher innerhalb V1.1 mehr offen — das Programm ist geschlossen. Post-Release-Git-Abschluss nach `b096786`/`cbed101` war clean. Aktueller Working Tree enthält uncommitted Governance-/Agenten-/Architekturänderungen (siehe Update-Absatz unten) und wartet auf Commit/Push. Jede Erweiterung des Scopes (Delivery-Skalierung, neue Makroprojekte V11-09 ff.) erfordert eine eigene, gesonderte Editor-Entscheidung — kein automatischer Anschluss von dieser Session aus.

**Update (2026-07-13, Governance-Integration-Block):** Die oben und in Abschnitt „Nicht-blockierende, programmweit weitergeführte Punkte" genannten vier Reserved Decisions OD-009 bis OD-012 sind entschieden (OD-009 zurückgestellt/Option C; OD-010 Option B; OD-011 Option A; OD-012 Option A mit dokumentiertem Vorbehalt) und redaktionell integriert. Details: `00_project/EDITOR_DECISION_OD-009_TO_OD-012_2026-07-13.md`, `00_project/GOVERNANCE_INTEGRATION_OD-009_TO_OD-012_COMPLETION_REPORT_2026-07-13.md`. Weiterhin offen, durch diesen Block nicht gelöst: T12, MEC-0002/P-0002-Evidenzlevel, additives Synthesemuster, RP-005/RP-006.
