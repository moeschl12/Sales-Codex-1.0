...
| OD-003 | Framework v1.1 einfrieren | Offen im Text, mit v1.1-Release seit `99_archive/00_project_history/RELEASE_NOTES_v1.1.md` (2026-06-30) faktisch vollzogen | Niedrig — de facto bereits erledigt | Niedrig | **DONE** — Formal schließen. |
