...
**Welches Problem der Skill löst:** Externe Kritik wird häufig entweder komplett übernommen (Verlust eigener Standards) oder komplett ignoriert (Verlust an Selbstkorrektur). Dieses Projekt hat das Muster mindestens sechsmal unabhängig wiederholt: `PEER_REVIEW_DECISION_REPORT_SPRINT_001.md`, `PEER_REVIEW_DECISION_REPORT_SPRINT_002.md`, `BEHAVIORAL_SCIENCE_REVIEW_DECISION_REPORT_2026-07.md`, `OPEN_DECISION_RESOLUTION_REPORT_2026-07.md`, ⚠ `FINAL_RC1_AUDIT_VALIDATION_REPORT.md` (19 Einzelkritikpunkte dreier Gutachten, laut Changelog-Eintrag 2026-07-04 — Volltext nicht gelesen), und implizit in `DECISION_POLICY.md` als formales Regelwerk für genau diesen Vorgang.
